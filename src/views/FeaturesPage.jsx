            ...
            <section className="py-24 bg-sbos-navy">
                <div className="max-w-3xl mx-auto px-6 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="/signup" className="bg-sbos-electric hover:bg-sbos-royal text-white font-semibold px-8 py-3.5 rounded-full text-sm transition-all duration-300 hover:scale-[1.02]">Get Started Free</Link>
