    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between relative z-10">
                <Link href="/" className="flex items-center gap-2 group focus:outline-none focus-visible:ring-2 focus-visible:ring-sbos-electric rounded-md">
                    <img
            ...
            <div className={`absolute top-full left-0 w-full mt-2 bg-white/95 backdrop-blur-xl border border-sbos-electric/10 rounded-2xl shadow-xl overflow-hidden lg:hidden flex flex-col origin-top transition-all duration-300 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] ${mobileMenuOpen ? 'scale-y-100 opacity-100 p-4 gap-4' : 'scale-y-0 opacity-0 h-0 p-0'}`}>
                ...
                <a href="https://app.sbos.tech" onClick={() => setMobileMenuOpen(false)} className="w-full bg-sbos-royal hover:bg-sbos-electric text-white px-6 py-3 mt-2 rounded-xl text-base font-semibold transition-transform duration-300 active:scale-95 block text-center">
                    Get Started
                </a>
            </div>
