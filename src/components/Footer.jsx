                ...
                <div className="bg-sbos-navy/50 border border-sbos-royal/30 rounded-3xl p-10 md:p-16 mb-20 text-center backdrop-blur-md relative overflow-hidden">
                    ...
                    <div className="relative z-10 max-w-2xl mx-auto flex flex-col items-center">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto justify-center">
                            <button onClick={() => router.push('/signup')} className="w-full sm:w-auto bg-sbos-royal hover:bg-sbos-electric text-white px-10 py-4 rounded-full text-base font-semibold transition-all duration-300 hover:scale-[1.03] hover:shadow-lg hover:shadow-sbos-electric/25">
                    ...
                    <div className="md:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-8">
                        <div>
                            ...
                            <ul className="space-y-3">
                                <li><a href="/#demo" className="text-sbos-slate hover:text-white text-sm transition-colors">Features</a></li>
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                <li><Link href="/signup" className="text-sbos-slate hover:text-white text-sm transition-colors">Request Access</Link></li>
